...
public class sort_content_data {
	...
	public static void main(String[] args) {
		String path = System.getProperty("user.dir")+ File.separatorChar+"test"
				+File.separatorChar+"sort_content_data_1.json";
		String path2 = System.getProperty("user.dir")+ File.separatorChar+"test"
				+File.separatorChar+"sort_content_data_2.json";
		String path3 = System.getProperty("user.dir")+ File.separatorChar+"test"
				+File.separatorChar+"sort_content_data.json";
